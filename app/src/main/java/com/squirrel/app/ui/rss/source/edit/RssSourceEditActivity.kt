package com.squirrel.app.ui.rss.source.edit
...
import com.squirrel.app.databinding.ActivityRssSourceEditBinding
...
import com.squirrel.app.ui.rss.source.debug.RssSourceDebugActivity
    ...
    override fun onCompatOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.menu_login -> viewModel.save(getRssSource()) {
                startActivity<com.squirrel.app.ui.login.SourceLoginActivity> {
