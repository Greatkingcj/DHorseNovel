...
import com.squirrel.app.databinding.ItemRssArticle1Binding
...
class RssArticlesAdapter1(context: Context, callBack: CallBack) :
    com.squirrel.app.ui.rss.article.BaseRssArticlesAdapter<ItemRssArticle1Binding>(context, callBack) {
