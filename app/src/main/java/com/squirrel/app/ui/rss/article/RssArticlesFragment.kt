...
import com.squirrel.app.databinding.FragmentRssArticlesBinding
import com.squirrel.app.databinding.ViewLoadMoreBinding
...
import com.squirrel.base.ui.widget.recycler.LoadMoreView
...
class RssArticlesFragment() : VMBaseFragment<RssArticlesViewModel>(R.layout.fragment_rss_articles),
    com.squirrel.app.ui.rss.article.BaseRssArticlesAdapter.CallBack {
    ...
    private val adapter: com.squirrel.app.ui.rss.article.BaseRssArticlesAdapter<*> by lazy {
        when (activityViewModel.rssSource?.articleStyle) {
            ...
            else -> com.squirrel.app.ui.rss.article.RssArticlesAdapter(
                requireContext(),
                this@RssArticlesFragment
            )
        }
    }
