...
# 保持js引擎调用的java类
-keep class * extends com.squirrel.base.help.JsExtensions{*;}
# 保持js引擎调用的java类
...
## 对外提供api
-keep class com.squirrel.novel.api.ReturnData{*;}
...
# Class.forName调用
-keep class com.squirrel.base.lib.cronet.CronetInterceptor{*;}
-keep class com.squirrel.base.lib.cronet.CronetLoader{*;}
-keep class com.squirrel.base.help.AppUpdateGitHub{*;}
-keep class com.squirrel.base.help.AppIntentType{*;}
# Error Exception 
