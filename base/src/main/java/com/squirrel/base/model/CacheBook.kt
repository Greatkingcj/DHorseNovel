...
import com.squirrel.base.exception.ConcurrentException
    ...
    class CacheBookModel(var bookSource: BookSource, var book: Book) {
        ...
        fun download(
            ...
            WebBook.getContent(
                ...
                onSuccess(chapter)
                com.squirrel.base.model.ReadBook.downloadedChapters.add(chapter.index)
                com.squirrel.base.model.ReadBook.downloadFailChapters.remove(chapter.index)
                downloadFinish(chapter, content, resetPageOffset)
            }.onError {
                onError(chapter, it)
                com.squirrel.base.model.ReadBook.downloadFailChapters[chapter.index] =
                    (com.squirrel.base.model.ReadBook.downloadFailChapters[chapter.index] ?: 0) + 1
        ...
        private fun downloadFinish(
            ...
            if (com.squirrel.base.model.ReadBook.book?.bookUrl == book.bookUrl) {
                com.squirrel.base.model.ReadBook.contentLoadFinish(
