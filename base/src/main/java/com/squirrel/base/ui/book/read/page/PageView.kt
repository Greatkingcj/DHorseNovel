...
import com.squirrel.base.constant.AppConst.timeFormat
import com.squirrel.base.data.entities.Bookmark
import com.squirrel.base.databinding.ViewBookPageBinding
...
import com.squirrel.base.ui.widget.BatteryView
import com.squirrel.base.utils.activity
import com.squirrel.base.utils.dpToPx
import com.squirrel.base.utils.gone
import com.squirrel.base.utils.setTextIfNotEqual
import com.squirrel.base.utils.statusBarHeight
...
class PageView(context: Context) : FrameLayout(context) {
    ...
    fun upStatusBar() = with(binding.vwStatusBar) {
        ...
        isGone = ReadBookConfig.hideStatusBar == true
    }
