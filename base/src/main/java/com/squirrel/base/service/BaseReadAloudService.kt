...
import com.squirrel.base.Receiver.MediaButtonReceiver
import com.squirrel.base.ui.book.read.page.entities.TextChapter
import com.squirrel.base.utils.activityPendingIntent
import com.squirrel.base.utils.broadcastPendingIntent
...
abstract class BaseReadAloudService : BaseService(),
    ...
    override fun onCreate() {
        ...
        execute {
            ...
            ImageLoader
                .loadBitmap(this@BaseReadAloudService, com.squirrel.base.model.ReadBook.book?.getDisplayCover())
                .submit()
                .get()
        }.onSuccess {
            cover = it
    ...
    override fun onDestroy() {
        ...
        com.squirrel.base.model.ReadBook.uploadProgress()
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when (intent?.action) {
            IntentAction.play -> newReadAloud(
                ...
                intent.getIntExtra("pageIndex", com.squirrel.base.model.ReadBook.durPageIndex),
    ...
    private fun newReadAloud(play: Boolean, pageIndex: Int, startPos: Int) {
        execute(executeContext = IO) {
            ...
            textChapter = com.squirrel.base.model.ReadBook.curTextChapter
        ...
        if (nowSpeak > 0) {
            ...
            textChapter?.let {
                ...
                if (readAloudNumber < it.getReadLength(pageIndex)) {
                    pageIndex--
                    com.squirrel.base.model.ReadBook.moveToPrevPage()
                }
            }
    ...
    private fun createNotification(): NotificationCompat.Builder {
        ...
        nTitle += ": ${com.squirrel.base.model.ReadBook.book?.name}"
        var nSubtitle = com.squirrel.base.model.ReadBook.curTextChapter?.title
    ...
    open fun nextChapter() {
        com.squirrel.base.model.ReadBook.upReadTime()
        AppLog.putDebug("${com.squirrel.base.model.ReadBook.curTextChapter?.chapter?.title} 朗读结束跳转下一章并朗读")
        if (!com.squirrel.base.model.ReadBook.moveToNextChapter(true)) {
            stopSelf()
        }
    }
